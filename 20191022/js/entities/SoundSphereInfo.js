...
class SoundSphereInfo {
    constructor() {
        ...
        this.change = [
            ...
            "1.4.17 - Correção bug comando de voz, Correção do BUG que ao clicar em recomeçar se perdia o histórico, correção do reset vertical, inclusão do nome do autor."
        ];

...
class PageSoundSphereHome extends SimplePage {
  ...
  <div class="actions">
    ...
    generateSetingsOptionModal() {
        $('#buttonPlayAudioSemEfeito').on('mouseout', (e) => {
            this.sequenciador.stopOneSound();
        });
        $('#buttonPlayAudioSemEfeito').on('mouseover', (e) => {
        ...
        $('#playAudioComOptions').on('mouseleave', (e) => {
            console.log("mouse mouseleave");
            this.sequenciador.stopOneSound();
        });
        $('#playAudioComOptions').on('mouseover', (e) => {

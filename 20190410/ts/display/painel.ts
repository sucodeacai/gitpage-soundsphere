...
class Painel {
  ...
  canvas: any;
  constructor(daoHome: DAO, ctxCanvas: any, canvas: any, pageSoundSphereHome: PageSoundSphereHome) {
  ...
  setSettings() {
    ...
    //Mouse event
    this.canvas.addEventListener("touchcancel", (evt: any) => this.actionEndTouchInPanel(evt), false);
    this.canvas.addEventListener("dblclick", (evt: any) => { evt.preventDefault(); }, false);
    this.canvas.addEventListener("mousedown", (evt: any) => this.actionMouseDown(evt));
    this.canvas.addEventListener("mouseout", (evt: any) => this.actionMouseOut(evt));
    this.canvas.addEventListener("mouseup", (evt: any) => this.actionMouseUp(evt));
    this.canvas.addEventListener("mousemove", (evt: any) => this.actionMouseMove(evt));

...
abstract class DAO {
     ...
     * @returns void
     */
    abstract soundSphereDBToJson(bufferList: ItemBuffer[], listItemMixPanel: ItemMixPanel[][], listSemanticDescriptors: SemanticDescriptor[], soundSphereInfo: SoundSphereInfo): void;
    constructor(soundSphereInfo: SoundSphereInfo, listSemanticDescriptors: SemanticDescriptor[], audioCtx: AudioContext | any, controlFiles: ControlFiles) {
    ...
    loadBufferList(listAudioData: any, callback: any) {

...
class Painel {
            ...
            if ((this.mouseDownX != evt.offsetX) || (this.mouseDownY != evt.offsetY)) {
                if (this.mouseDown) {
                    if (this.moved) {
                        ...
                        if (diferenceX == 1 || diferenceX == -1) {
                            this.deltaX = 0;
                        }
                        else if (diferenceX > 1 && diferenceX < 100) {
                        ...
                        if (diferenceY == 1 || diferenceY == -1) {
                            this.deltaY = 0;
                        }
                        else if (diferenceY > 1 && diferenceY < 100) {
    ...
    moveAction() {
        ...
        this.reMake();
        if (this.mouseDown) {
            requestAnimationFrame(() => { this.moveAction(); });
        }
    }

...
class Painel {
    ...
    insertItemMixPanel(idSoundIconSelect) {
        ...
        if (desenha) {
            ...
            var i;
            //Set que precisa gerar novamente o Generate Buffer no Mix
        ...
        if (linha == newLinha) {
            for (let index = 0; index < this.DAOHome.listItemMixPanel[linha].length; index++) {
                ...
                if (this.DAOHome.listItemMixPanel[linha][index].id == itemMixPanel.id) {
                    ...
                    this.DAOHome.listItemMixPanel[linha][index].setCodeSemanticDescriptor(itemMixPanel.getCodeSemanticDescriptor());
    ...
    moveDisplacingXMarker(currentMarkerX) {
        ...
        if (currentMarkerX > this.halfPainel + this.displacingXAxis) {
    ...
    drawStoppedMarker(totalTime) {
        ...
        if (this.displacingXAxis < xPositionBySeconds) {
            ...
            if (xPositionBySeconds <= this.halfPainel) {
    ...
    ajustDisplacing() {
        ...
        if (this.xMarker > this.halfPainel && this.displacingXAxis < this.xMarker - this.halfPainel) {
            this.resetTranslateX();
            this.ctxCanvas.translate(-(this.xMarker - this.halfPainel), 0);
        ...
        if (this.xMarker < this.halfPainel && this.displacingXAxis != 0) {
            this.resetTranslateX();
        }
        ...
        if (this.xMarker > this.halfPainel && this.displacingXAxis > this.xMarker) {
            this.resetTranslateX();
            this.ctxCanvas.translate(-(this.xMarker - this.halfPainel), 0);
            this.displacingXAxis = this.xMarker - this.halfPainel;
        }

...
class PageSoundSphereHome extends SimplePage {
    ...
    constructor(containerElement, titulo, soundSphereInfo, dao, sequenciador, tooltip, sessionInformation) {
    ...
    generateHTML() {
        ...
        conoteudoHTML += this.sessionInformation.getLastEventNameValid() != undefined ? " - " + this.sessionInformation.getLastEventNameValid() : "";
        conoteudoHTML += `</p>
                </div>
              </h2>

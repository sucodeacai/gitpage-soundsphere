    ...
    drawPadrao(painel, y, height, yDescritor) {
        ...
        if (this.solo) {
            if (painel.drawGradient) {
                ...
                my_gradient.addColorStop(0, this.colorGray[this.volume]);
